            ...
            if (!updateChecked) {
                ...
                new Thread(() -> {
                    ...
                    if (latestRelease != null && latestRelease.has("promos")) {
                        ...
                        if (promos.has("1.19.4-recommended")) {
                            String recommendedVersion = promos.get("1.19.4-recommended").getAsString().substring(1);

                            String currentVersion = IdleTweaks.VERSION;

                            if (currentVersion.compareTo(recommendedVersion) < 0) {
                                String releaseURL = "https://modrinth.com/mod/Vnjlu1sC/versions?g=1.19.4";
