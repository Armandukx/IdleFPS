    ...
    public static void init(){
        ClientTickEvents.START_CLIENT_TICK.register(client -> {
            ...
            if (!MinecraftClient.getInstance().isWindowFocused()) {
                ...
                if (IdleTweaks.getConfig().bDistToggle) {
                    gameSettings.viewDistance = IdleTweaks.getConfig().backgroundRenderDist;
                }
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (client.world != null) {
                ...
                int currentDist = IdleTweaks.gameSettings.viewDistance;
                int currentFps = IdleTweaks.gameSettings.maxFps;
