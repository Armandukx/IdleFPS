        ...
        try {
            ...
            while (line != null) {
                ...
                if (tokens.length == 2) {
                    ...
                    switch (key) {
                        case "bFpsToggle":
                            this.bFpsToggle = Boolean.parseBoolean(value);
                            break;
                        case "bDistToggle":
                            this.bDistToggle = Boolean.parseBoolean(value);
                            break;
                        case "bVolumeToggle":
                            this.bVolumeToggle = Boolean.parseBoolean(value);
                            break;
                        case "backgroundFps":
                            this.backgroundFps = Integer.parseInt(value);
                            break;
                        case "backgroundRenderDist":
                            this.backgroundRenderDist = Integer.parseInt(value);
                            break;
                        default:
                            break;
                    }
