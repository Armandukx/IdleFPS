...
import io.armandukx.command.IDTCommand;
...
public class IdleTweaks {
    ...
    public static final String prefix =
            TextFormatting.WHITE + "[" + TextFormatting.WHITE + "I" + TextFormatting.YELLOW + "F" + TextFormatting.GREEN + "P" + TextFormatting.RED + "S"
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        ClientCommandHandler.instance.registerCommand(new IDTCommand());
    }
    @Mod.EventHandler
    ...
    public void onRenderGameOverlay(RenderGameOverlayEvent event) {
        if (event.getType() == RenderGameOverlayEvent.ElementType.TEXT && !retrieved) {
